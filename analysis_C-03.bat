@echo off
rem This batch file checks for required Python libraries and runs the C-03 analysis script.
...
echo Running the Python analysis script 'analysis_C-03.py'...
python analysis_C-03.py
