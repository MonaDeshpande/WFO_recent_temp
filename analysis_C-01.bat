@echo off
rem This batch file checks for required Python libraries and runs the C-01 analysis script.
...
echo Running the Python analysis script 'analysis_C-01.py'...
python analysis_C-01.py
